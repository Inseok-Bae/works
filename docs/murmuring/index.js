...
function update_graph_presenter(conversationsChart, data) {
...
// raw-file:/home/qodls/code/works/models/conversations.js
...
// raw-file:/home/qodls/code/works/models/speaker.js
...
// raw-file:/home/qodls/code/works/models/murmurer.js
...
// raw-file:/home/qodls/code/works/murmuring/acting.js
...
var Conversations = class {
  ...
  push({ content, by }) {
    this.records.push({ content, by, when: /* @__PURE__ */ new Date() });
  }
  getLastRecord() {
    return this.records[this.records.length - 1];
  }
...
// models/speaker.js
var Speaker = class {
  constructor({ public_conversations: public_conversations2, name }) {
    this.delay = get_random_int(1e3, 3e3);
    this.ownContent = get_random_int(1, 10);
    this.public_conversations = public_conversations2;
    this.name = name;
    this.join();
  }
  join() {
...
// models/murmurer.js
var Murmurer = class extends Speaker {
  constructor({ public_conversations: public_conversations2, name }) {
    super({ public_conversations: public_conversations2, name });
    this.delay = this.delay * 10 + 3e3;
    this.ownContent = 0;
    this.regret = observable([]);
    this.limit = 10;
  }
    ...
    try {
      occasionally(() => {
        ...
        try {
          occasionally(() => {
            const spoken = something;
            this.regret.push({ content: spoken, when: /* @__PURE__ */ new Date(), by: this.name });
          });
        } catch (_) {
        }
      });
      ...
      const unspoken = something;
      this.regret.push({ content: unspoken, when: /* @__PURE__ */ new Date(), by: this.name });
    }
  }
};
...
// murmuring/acting.js
var acting = () => {
  const public_conversations2 = new Conversations();
  new Speaker({
    public_conversations: public_conversations2,
    name: "speaker"
  });
  const mumurer = new Murmurer({
    public_conversations: public_conversations2,
  ...
  public_conversations2.push({ content: 0, by: "wind" });
  return {
    public_conversations: public_conversations2,
    murmurer_regret: mumurer.regret
  };
